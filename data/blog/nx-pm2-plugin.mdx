...
[Nx](https://nx.dev/) provides a [NestJS](https://nestjs.com/) generator to setup a NestJS project within the monorepo.

First install the NestJS generator.

```bash
npm install -D @nx/nest
```

Then generate a NestJS project.
